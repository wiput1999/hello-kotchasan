...
/**
 * Generated by PHPUnit_SkeletonGenerator on 2018-12-11 at 22:26:50.
 */
class InputItemTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testDate3()
    {
        ...
        $this->assertEquals(
          '2016-01-01 20:20:20', $this->object->create('2016-01-01   20:20:20')->date(true)
        );
    }
    ...
    public function testDate4()
    {
        ...
        $this->assertEquals(
          '20:20:20', $this->object->create('20:20:20')->date()
        );
    }
    ...
    public function testDate5()
    {
        ...
        $this->assertEquals(
          '20:20', $this->object->create('20:20')->date()
        );
    }
    ...
    public function testDate6()
    {
        ...
        $this->assertEquals(
          '20:20:00', $this->object->create('20:20')->date(true)
        );
    }
    ...
    public function testDate7()
    {
        ...
        $this->assertEquals(
          '2016-01-01', $this->object->create('2016-01-01')->date()
        );
    }
    ...
    public function testDate9()
    {
        ...
        $this->assertEquals(
          null, $this->object->create(null)->date()
        );
    }
    ...
    public function testTime()
    {
        ...
        $this->assertEquals(
          '20:20:20', $this->object->create('20:20:20')->time()
        );
    }
    ...
    public function testTime5()
    {
        ...
        $this->assertEquals(
          '20:20', $this->object->create('20:20')->time()
        );
    }
    ...
    public function testTime6()
    {
        ...
        $this->assertEquals(
          '20:20:00', $this->object->create('20:20')->time(true)
        );
    }
    ...
    public function testDescription()
    {
        ...
        $this->assertEquals(
          'ท.ด(ส )อ บ', $this->object->create("ท.ด(ส     )อ\"บ'\r\n\t<?php echo '555'?>")->description()
        );
    }
    ...
    public function testDescription2()
    {
        ...
        $this->assertEquals(
          'ทดสอบ', $this->object->create('ทดสอบ<style>body {color: red}</style>')->description()
        );
    }
    ...
    public function testDescription3()
    {
        ...
        $this->assertEquals(
          'ทดสอบตัวหนา', $this->object->create('ทดสอบ<b>ตัวหนา</b>')->description()
        );
    }
    ...
    public function testDescription4()
    {
        ...
        $this->assertEquals(
          'ทดสอบ', $this->object->create('ทดสอบ{LNG_Language name}')->description()
        );
    }
    ...
    public function testDescription5()
    {
        ...
        $this->assertEquals(
          'ทดสอบ', $this->object->create('ทดสอบ[code]ตัวหนา[/code]')->description()
        );
    }
    ...
    public function testDescription7()
    {
        ...
        $this->assertEquals(
          '2 > 1 < 3 > 2', $this->object->create('2 > 1 < 3 > 2{WIDGET_XXX}')->description()
        );
    }
    ...
    public function testDescription8()
    {
        ...
        $this->assertEquals(
          'ทดสอบ', $this->object->create('ทดสอบ<!--WIDGET_XXX-->')->description()
        );
    }
    ...
    public function testDescription9()
    {
        ...
        $this->assertEquals(
          'ท ด \ /__ส-อ+บ', $this->object->create('ท&amp;ด&quot;\&nbsp;/__ส-อ+บ')->description()
        );
    }
    ...
    public function testDescription10()
    {
        ...
        $this->assertEquals(
          'ภา', $this->object->create('ภาคภูมิ')->description(2)
        );
    }
