...
/**
 * Generated by PHPUnit_SkeletonGenerator on 2020-02-11 at 17:41:42.
 */
class QueryBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        echo  $this->object->unionAll(Sql::create('SELECT * FROM `a`'), Sql::create('SELECT * FROM `b`'))->text();
        $this->assertEquals(
    ...
    /**
     * @covers Kotchasan\Database\QueryBuilder::explain
