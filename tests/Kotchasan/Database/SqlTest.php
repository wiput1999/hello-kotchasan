...
/**
 * Generated by PHPUnit_SkeletonGenerator on 2018-08-16 at 08:43:09.
 */
class SqlTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testBETWEEN()
    {
        ...
        $this->assertEquals(
          "`create_date` BETWEEN `create_date` AND U.`create_date`", \Kotchasan\Database\Sql::BETWEEN('create_date', 'create_date', 'U.create_date')->text()
        );
    }
    ...
    public function testBETWEEN2()
    {
        ...
        $this->assertEquals(
          "`create_date` BETWEEN `table_name`.`field_name` AND U.`create_date`", \Kotchasan\Database\Sql::BETWEEN('create_date', 'table_name.field_name', 'U.`create_date`')->text()
        );
    }
    ...
    public function testBETWEEN3()
    {
        ...
        $this->assertEquals(
          "`create_date` BETWEEN `database`.`table` AND '12-1-1'", \Kotchasan\Database\Sql::BETWEEN('create_date', '`database`.`table`', '12-1-1')->text()
        );
    }
    ...
    public function testBETWEEN4()
    {
        ...
        $this->assertEquals(
          "`create_date` BETWEEN 0 AND 1", \Kotchasan\Database\Sql::BETWEEN('create_date', 0, 1)->text()
        );
    }
    ...
    public function testDISTINCT()
    {
        ...
        $this->assertEquals(
          'DISTINCT `id`', \Kotchasan\Database\Sql::DISTINCT('id')->text()
        );
    }
    ...
    public function testHOUR()
    {
        ...
        $this->assertEquals(
          'HOUR(`create_date`)', \Kotchasan\Database\Sql::HOUR('create_date')->text()
        );
    }
    ...
    public function testHOUR2()
    {
        ...
        $this->assertEquals(
          'HOUR(`create_date`) AS `date`', \Kotchasan\Database\Sql::HOUR('create_date', 'date')->text()
        );
    }
    ...
    public function testIFNULL()
    {
        ...
        $this->assertEquals(
          "IFNULL(`create_date`, U.`create_date`)", \Kotchasan\Database\Sql::IFNULL('create_date', 'U.create_date')->text()
        );
    }
    ...
    public function testIFNULL2()
    {
        ...
        $this->assertEquals(
          "IFNULL(`create_date`, U.`create_date`) AS `test`", \Kotchasan\Database\Sql::IFNULL('create_date', 'U.create_date', 'test')->text()
        );
    }
    ...
    public function testISNOTNULL()
    {
        ...
        $this->assertEquals(
          "U.`id` IS NOT NULL", \Kotchasan\Database\Sql::ISNOTNULL('U.id')->text()
        );
    }
    ...
    public function testISNULL()
    {
        ...
        $this->assertEquals(
          "U.`id` IS NULL", \Kotchasan\Database\Sql::ISNULL('U.id')->text()
        );
    }
    ...
    public function testMINUTE()
    {
        ...
        $this->assertEquals(
          'MINUTE(`create_date`)', \Kotchasan\Database\Sql::MINUTE('create_date')->text()
        );
    }
    ...
    public function testMINUTE2()
    {
        ...
        $this->assertEquals(
          'MINUTE(`create_date`) AS `date`', \Kotchasan\Database\Sql::MINUTE('create_date', 'date')->text()
        );
    }
    ...
    public function testSECOND()
    {
        ...
        $this->assertEquals(
          'SECOND(`create_date`)', \Kotchasan\Database\Sql::SECOND('create_date')->text()
        );
    }
    ...
    public function testSECOND2()
    {
        ...
        $this->assertEquals(
          'SECOND(`create_date`) AS `date`', \Kotchasan\Database\Sql::SECOND('create_date', 'date')->text()
        );
    }
    ...
    public function testTIMEDIFF()
    {
        ...
        $this->assertEquals(
          "TIMEDIFF(`create_date`, NOW())", \Kotchasan\Database\Sql::TIMEDIFF('create_date', Sql::NOW())->text()
        );
    }
    ...
    public function testTIMEDIFF2()
    {
        ...
        $this->assertEquals(
          "TIMEDIFF('2017-04-04', `create_date`)", \Kotchasan\Database\Sql::TIMEDIFF('2017-04-04', 'create_date')->text()
        );
    }
    ...
    public function testFieldName3()
    {
        ...
        $this->assertEquals(
          'U1.`id` DESC', \Kotchasan\Database\Sql::fieldName('U1.id DESC')
        );
    }
    ...
    public function testFieldName9()
    {
        ...
        $this->assertEquals(
          '`table_name`.`field_name` ASC', \Kotchasan\Database\Sql::fieldName('`table_name`.field_name ASC')
        );
    }
    ...
    public function testQuoteValue()
    {
        ...
        $this->assertEquals(
          "'ทดสอบ'", \Kotchasan\Database\Sql::quoteValue('id', 'ทดสอบ', $array)
        );
    }
    ...
    public function testQuoteValue2()
    {
        ...
        $this->assertEquals(
          "'test'", \Kotchasan\Database\Sql::quoteValue('id', 'test', $array)
        );
    }
    ...
    public function testQuoteValue3()
    {
        ...
        $this->assertEquals(
          "'abcde012345'", \Kotchasan\Database\Sql::quoteValue('id', 'abcde012345', $array)
        );
    }
    ...
    public function testQuoteValue4()
    {
        ...
        $this->assertEquals(
          123456, \Kotchasan\Database\Sql::quoteValue('id', 123456, $array)
        );
    }
    ...
    public function testQuoteValue5()
    {
        ...
        $this->assertEquals(
          0.1, \Kotchasan\Database\Sql::quoteValue('id', 0.1, $array)
        );
    }
    ...
    public function testQuoteValue6()
    {
        ...
        $this->assertEquals(
          'NULL', \Kotchasan\Database\Sql::quoteValue('id', null, $array)
        );
    }
    ...
    public function testQuoteValue7()
    {
        ...
        $this->assertEquals(
          "U.`id`", \Kotchasan\Database\Sql::quoteValue('id', 'U.id', $array)
        );
    }
    ...
    public function testQuoteValue9()
    {
        ...
        $this->assertEquals(
          "'domain.tld'", \Kotchasan\Database\Sql::quoteValue('id', 'domain.tld', $array)
        );
    }
    ...
    public function testQuoteValue10()
    {
        ...
        $this->assertEquals(
          '`table_name`.`id`', \Kotchasan\Database\Sql::quoteValue('id', 'table_name.`id`', $array)
        );
    }
    ...
    public function testQuoteValue13()
    {
        ...
        $this->assertEquals(
          ':id0', \Kotchasan\Database\Sql::quoteValue('id', 'INSERT INTO', $array)
        );
    }
    ...
    public function testQuoteValue14()
    {
        ...
        $this->assertEquals(
          "(1, '2', NULL)", \Kotchasan\Database\Sql::quoteValue('id', array(1, '2', null), $array)
        );
    }
    ...
    public function testQuoteValue15()
    {
        ...
        $this->assertEquals(
          ':id0', \Kotchasan\Database\Sql::quoteValue('id', '0x64656', $array)
        );
    }
    ...
    public function testQuoteValue16()
    {
        ...
        $this->assertEquals(
          411222, \Kotchasan\Database\Sql::quoteValue('id', 0x64656, $array)
        );
    }
    ...
    public function testQuoteValue17()
    {
        ...
        $this->assertEquals(
          ':tablenameid0', \Kotchasan\Database\Sql::quoteValue('`table_name`.`id`', '0x64656', $array)
        );
    }
    ...
    public function testQuoteValue18()
    {
        ...
        $this->assertEquals(
          ':u1id0', \Kotchasan\Database\Sql::quoteValue('U1.`id`', '0x64656', $array)
        );
    }
    ...
    public function testQuoteValue19()
    {
        ...
        $this->assertEquals(
          ':uid0', \Kotchasan\Database\Sql::quoteValue('U.id', '0x64656', $array)
        );
    }
}