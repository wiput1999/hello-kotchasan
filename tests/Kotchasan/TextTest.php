...
/**
 * Generated by PHPUnit_SkeletonGenerator on 2018-10-19 at 10:02:54.
 */
class TextTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testPassword()
    {
        ...
        $this->assertEquals(
          '0123465ทดสอบ@#$&{}!?+_-=', \Kotchasan\Text::password(" 0\n12   34\r\r6\t5ทดสอบ@#$&{}!?+_-=")
        );
    }
    ...
    public function testRemoveNonCharacters()
    {
        ...
        $this->assertEquals(
          chr(0).chr(127), \Kotchasan\Text::removeNonCharacters(chr(0).chr(127).chr(128).chr(255))
        );
    }
    ...
    public function testTopic()
    {
        ...
        $this->assertEquals(
          'ทด&#92;/สอบ &lt;?php echo &#039;555&#039;?&gt;', \Kotchasan\Text::topic(' ทด\/สอบ'."\r\n\t".'<?php echo \'555\'?> ')
        );
    }
    ...
    public function testUrl()
    {
        ...
        $this->assertEquals(
          'http://www.kotchasan.com?a=1&amp;b=2&amp;c=3', \Kotchasan\Text::url(" http://www.kotchasan.com?a=1&b=2&amp;c=3 ")
        );
    }
    ...
    public function testUrl2()
    {
        ...
        $this->assertEquals(
          'alertxxx', \Kotchasan\Text::url("javascript:alert('xxx')")
        );
    }
    ...
    public function testUrl3()
    {
        ...
        $this->assertEquals(
          'http://www.xxx.com/javascript/', \Kotchasan\Text::url("http://www.xxx.com/javascript/")
        );
    }
