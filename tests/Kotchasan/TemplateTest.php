...
/**
 * Generated by PHPUnit_SkeletonGenerator on 2017-06-27 at 13:26:44.
 */
class TemplateTest extends \PHPUnit_Framework_TestCase
{
  ...
  public function testPregReplace2()
  {
    ...
    $this->assertEquals(
      '<b>Language test</b>', \Kotchasan\Template::pregReplace('/{LNG_([\w\s\.\-\'\(\),%\/:&\#;]+)}/e', '\Kotchasan\Language::parse(array(1=>"$1"))', '<b>{LNG_Language test}</b>')
    );
  }
}
